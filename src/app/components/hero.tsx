...
return (<div className="home" id="home">
        <div className="home-content">
          ...
          <p>
            ...
            pariatur! At iure explicabo quo neque labore maiores voluptatem
            velit soluta?
          </p>
          <div className="social-media">
            <Link href="#"><i className="fa-brands fa-facebook"></i></Link>
            <Link href="#"><i className="fa-brands fa-twiter"></i></Link>
        ...
        <Image src='/Assets/Fareed.jpg' height={200} width={200} alt='Fareed Picture'></Image>
        </div>
    </div>
 )
}